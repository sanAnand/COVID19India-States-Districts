...
from external import extract_element_from_json, unique, GetTop10Districts, GetDates, GetRawData, cleanRawData , GetTopTrends , GetCSVfromDict, GetTrendsStates
...
cityTrends = GetTrendsStates(rawData) # Get info about top 10 cities. City and dates with cases (no frequency)
...
#np.savetxt('StateFreq.csv', [d],delimiter=",", fmt="%s")
